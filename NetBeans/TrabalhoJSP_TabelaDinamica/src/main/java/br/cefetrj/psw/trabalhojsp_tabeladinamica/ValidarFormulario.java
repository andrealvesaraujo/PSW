...
package br.cefetrj.psw.trabalhojsp_tabeladinamica;
...
public class ValidarFormulario extends HttpServlet {
    ...
    /**
     * Metodo que faz a validação dos dados de um formulario sobre um aluno da classe AlunoPSW.java atraves da interação com a pagina FormularioAlunoValido.jsp.Se os dados forem valido vão para a tabela TabelaDinamicaValida.jsp.
     * @author Andre
     * @version 1
     * @since 26/03/2018
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            if(valido){
                ...
                request.getRequestDispatcher("TabelaDinamicaValida.jsp").forward(request, response);//Mudar para a tabela
            }else{
              request.getRequestDispatcher("FormularioAlunoValido.jsp").forward(request, response);  
            }
