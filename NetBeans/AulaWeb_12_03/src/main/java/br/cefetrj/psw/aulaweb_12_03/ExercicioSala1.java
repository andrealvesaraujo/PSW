...
package br.cefetrj.psw.aulaweb_12_03;
 ...
 * 
 */
@WebServlet("/ExercicioSala1")
public class ExercicioSala1 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            ...
            {
                ArrayList<AlunoForm> tabelaAlunos = new <AlunoForm>ArrayList();
                tabelaAlunos.add(A);
                sc.setAttribute("ListaAlunos", tabelaAlunos);
            }else{
                ArrayList<AlunoForm> tabelaAlunos = (ArrayList<AlunoForm>) sc.getAttribute("ListaAlunos");
                tabelaAlunos.add(A);
                sc.setAttribute("ListaAlunos", tabelaAlunos);
            }
            ...
            for(AlunoForm aluno:(ArrayList<AlunoForm>) sc.getAttribute("ListaAlunos")){
