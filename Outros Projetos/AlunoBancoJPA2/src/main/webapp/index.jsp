<%-- 
    Document   : index
    Created on : 08/05/2018, 12:47:30
    Author     : Andre
--%>
            ...
            <div class="container ">
                ...
                <div class="row">              
                    ...
                    <div class="text-center form-group col-md-6">
                        <label>Materia :</label>
                        <selects:MateriaTag materia="${param.materia}"/>${msgErroMateria}<br>
                    </div>
                    <br>
                   
                </div>
                    <div class="text-center">
                        <input class="btn btn-info btn-md btn-sm"   type="submit" value="Enviar formulario para a tabela">
                    </div>
            </div>    
        </form>
