 ...
 */
package br.cefetrj.psw.projetobootstrapsembanco;
...
public class ValidarFormulario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            if(valido){
                //Buscar no banco a lista e adicinar uma linha
    ...
    private void PreencherServletContext(String nome,Double p1,Double tr,Double pj,Double fr,Double pf,ServletContext sc){
        ...
        /*
                EntityManagerFactory factory = Persistence.createEntityManagerFactory("br.cefetrj.psw_BancoDeDados_war_1.0-SNAPSHOTPU");
                EntityManager manager = factory.createEntityManager();
        
                manager.getTransaction().begin(); 
                manager.persist(A);
        
                List<Aluno> lista = manager.createQuery("select A from Aluno").getResultList()
        ...
        */
        ...
        {
            ArrayList<Aluno> tabelaAlunos = new <Aluno>ArrayList();
            tabelaAlunos.add(A);
