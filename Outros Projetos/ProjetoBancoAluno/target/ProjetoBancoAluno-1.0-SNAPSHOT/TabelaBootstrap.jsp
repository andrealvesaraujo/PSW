<%-- 
    Document   : TabelaBootrasp
    Created on : 08/05/2018, 12:50:25
    Author     : Andre
--%>
		...
		<table class="table table-striped table-bordered">
			...
			<tr>
                ...
                <div class="text-center">
                    <button type="button" class="btn btn-secondary" onclick="javascript:location.href = 'index.jsp'">Voltar ao formulario</button>
                </div>    
