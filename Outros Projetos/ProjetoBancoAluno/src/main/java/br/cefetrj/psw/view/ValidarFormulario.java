 ...
 */
package br.cefetrj.psw.view;

import br.cefetrj.psw.control.AlunoServices;
...
public class ValidarFormulario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            if(valido){
                ...
                Aluno A = new Aluno(nome, p1,tr,pj,fr,pf,materia);
                A.situacao();
                AlunoServices.incluirAluno(A);
                List<Aluno> lista = AlunoServices.buscarListaDeAlunos();
